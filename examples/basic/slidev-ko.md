...
자막은 Slidev의 presenter note를 기반으로 자동 생성됩니다.

```md
<!--
이 텍스트가 자막으로 표시됩니다.
줄바꿈을 하면 다음 페이지의 자막이 됩니다.
-->
```

<v-click>

`[click]` 마커를 사용하면 v-click 애니메이션과 자막을 동기화할 수 있습니다.
...
[click]
그리고 click 마커를 활용하면, v-click 애니메이션 타이밍에 맞춰 자막이 전환됩니다.
이렇게 하면 슬라이드의 시각적 변화와 자막이 자연스럽게 동기화되죠.
-->
